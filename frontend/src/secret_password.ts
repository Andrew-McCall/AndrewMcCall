...
<div class="flex flex-col items-center min-h-screen py-10 px-4 text-green-500">
  ...
  <div class="w-full max-w-xl mt-8 flex flex-col gap-4">
    <div class="flex flex-col sm:flex-row gap-2">
      ...
      <button id="pw-generate"
        class="bg-green-700 hover:bg-green-600 active:bg-green-800 text-white font-bold px-6 py-3 rounded cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950">
        Generate
      </button>
    </div>
  ...
  for (const [token, meaning] of TOKENS) {
    ...
    row.type = "button";
    row.className =
      "flex items-baseline gap-3 text-left cursor-pointer rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950";
  ...
  const renderPresets = (list: Preset[]) => {
    ...
    for (const preset of list) {
      ...
      chip.className =
        "text-sm border border-green-900 text-green-400 hover:bg-green-900/40 hover:text-green-200 rounded-full px-3 py-1 cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950";
